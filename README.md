...
**NuGeneX** is a four-step automated pipeline for the reconstruction and evaluation of nuclear genes from draft assemblies using *Candida albicans* (or other yeasts) as a model.  
